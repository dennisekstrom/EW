...
/**
 * Monitors orders - written completely by FXCM
 * 
 * @author Tobias W
 * 
 */
public class OrderMonitor {
	...
	private final O2GOrderRow mOrder;
	private final List<O2GTradeRow> mTrades;
	private final List<O2GClosedTradeRow> mClosedTrades;
