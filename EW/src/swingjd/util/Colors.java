...
public class Colors {
	...
	// private final Map<Integer, GradientPaint> colorMap = new HashMap<Integer,
	// GradientPaint>();
	 ...
	 */
	public List<Paint> getGlossyColor(int theme, int startPoint, int endpoint) {
		List<Paint> glossyColors = new ArrayList<Paint>();
		switch (theme) {
