 ...
 */
package swingjd.custom.component.button;
...
import swingjd.util.ColorUtils;
...
public class GradientButton extends JButton {
	...
	public void paintComponent(Graphics g) {
		...
		if (model.isRollover()) {
			setButtonColor(ColorUtils.getInStance().getGradientColor(
	...
	private void drawShape(Graphics2D g2d, int w, int h) {
		if (getButtonType() == ButtonType.BUTTON_ROUNDED_RECTANGLUR) {

			g2d.setPaint(getButtonColor());
		...
		} else if (getButtonType() == ButtonType.BUTTON_RECTANGULAR) {
			g2d.setPaint(getButtonColor());
			g2d.fillRect(1, 1, w - 2, h - 2);
			g2d.setPaint(new Color(100, 100, 100, 100));
			g2d.drawRect(0, 0, w - 1, h - 1);
		} else if (getButtonType() == ButtonType.BUTTON_OVAL) {
			g2d.setPaint(getButtonColor());
			g2d.fillOval(1, 1, w - 20, h - 2);
			g2d.setPaint(new Color(100, 100, 100, 100));
			g2d.drawOval(0, 0, w - 20, h - 1);
		} else if (getButtonType() == ButtonType.BUTTON_ELLIPSE) {
			g2d.setPaint(getButtonColor());
			...
			g2d.draw(shape);
		} else if (getButtonType() == ButtonType.BUTTON_CIRCULAR) {
		...
		} else if (getButtonType() == ButtonType.BUTTON_ROUNDED) {
			g2d.setPaint(getButtonColor());
	...
	public GradientPaint getButtonColor() {
		return buttonColor;
	}

	public void setButtonColor(GradientPaint buttonColor) {
