 ...
 */
package swingjd.custom.component.panel;
 ...
 * 
 */
public class StandardPanelTabbed extends JTabbedPane {
	 ...
	 *            label on the button
	 */
	public StandardPanelTabbed(int theme) {
		this.theme = theme;
	}
	 ...
	 *            panel type
	 */
	public StandardPanelTabbed(int theme, int panelType) {
